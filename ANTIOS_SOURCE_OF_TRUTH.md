...
| **Tool, Provider & MCP Architecture** | Canonical Tool & Provider Specification | `docs/architecture/PHASE37_39_ARCHITECTURE.md` | **PRIMARY SPEC** | Authoritative for tool tiers, selection preference, provider abstraction, and MCP justification. |
...
| **Package Generation Truth** | StudyLab Compiler Script | `sandbox/StudyLab/generate_apkg.py` | **COMPILER CONTRACT**| Authoritative for APKG format compliance. StudySourceCore is 100% out of scope. |
